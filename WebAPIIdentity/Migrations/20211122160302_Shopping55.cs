...
{
    public partial class Shopping55 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionSwedish = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLists_AspNetUsers_UserIdId",
                        column: x => x.UserIdId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOrders_OrderLists_OrderListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLists_UserIdId",
                table: "OrderLists",
                column: "UserIdId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOrders_OrderListId",
                table: "ProductOrders",
                column: "OrderListId");
